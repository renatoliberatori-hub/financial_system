...
/* Copilot subframe reload button spacing. */
.copilot-subframe-reload {
  margin-top: 12px;
}
  ...
  <div id="content"><!---->
    <div id="main-frame-error" class="interstitial-wrapper ">
      <div id="main-content">
        ...
        <div id="main-message">
          <h1>
            <span>Hum… Não consigo chegar a esta página</span>
          </h1>
          <!--?lit$943310646$-->
            <p><strong jscontent="hostName">jsdelivr.net</strong> demorou muito tempo para responder</p>
          
          <div id="diagnose-frame" class="hidden"></div>

          <!--?lit$943310646$-->
            <div id="suggestions-list">
              <p><!--?lit$943310646$-->Tente:</p>
              <ul class="">
                <!--?lit$943310646$--><!---->
                  <li>Verificando a conexão</li>
                <!----><!---->
                  <li><a href="chrome-error://chromewebdata/#buttons" onclick="toggleHelpBox()">Verificação de proxy e firewall</a></li>
                <!---->
              </ul>
            </div>
          

          <div class="error-code"><!--?lit$943310646$-->ERR_TIMED_OUT</div>
      ...
      <!--?lit$943310646$-->
        <div id="details">
          <!--?lit$943310646$--><!---->
            <div class="suggestions">
              <div class="suggestion-header">Verifique sua conexão com a Internet</div>
              <div class="suggestion-body">Verifique os cabos de rede, o modem e os roteadores.</div>
            </div>
          <!----><!---->
            <div class="suggestions">
              <div class="suggestion-header">Permita que o Microsoft Edge acesse a rede nas configurações do antivírus
          ou do firewall.</div>
              <div class="suggestion-body">Se já estiver listado como um programa com permissão para acessar a rede, tente
      removê-lo da lista e adicioná-lo novamente.</div>
            </div>
          <!----><!---->
            <div class="suggestions">
              <div class="suggestion-header">Se você usar um servidor proxy:</div>
              <div class="suggestion-body">Ir para
          o menu Microsoft Edge configurações &gt;
          <span jscontent="settingsTitle">Configurações</span>
          &gt;
          <span jscontent="advancedTitle">Sistema</span>
          &gt;
          <span jscontent="proxyTitle">Abrir as configurações de proxy do computador</span>
          &gt;
          LAN
          e desmarque a caixa de seleção "Usar um servidor proxy para sua LAN".</div>
            </div>
          <!---->
        </div>
    ...
    <!--?lit$943310646$-->
      <div class="footer">
        <div class="left-footer">
          <div class="edge-logo" alt=""></div>
          <div class="edge-branding-text"><!--?lit$943310646$-->Microsoft Edge</div>
        </div>
      </div>
    ...
    <!--?lit$943310646$-->
      <div id="sub-frame-error">
        <!-- Show details when hovering over the icon, in case the details are
             hidden because they're too large. -->
        <div class="icon "></div>
        <div id="sub-frame-error-details"><strong jscontent="hostName">jsdelivr.net</strong> demorou muito tempo para responder</div>
        <!--?lit$943310646$-->
      </div>
...
<script>var loadTimeDataRaw = {"details":"Detalhes","errorCode":"ERR_TIMED_OUT","fontfamily":"system-ui, sans-serif","fontfamilyMd":"system-ui, sans-serif","fontsize":"75%","footer":{"msg":"Microsoft Edge"},"heading":{"msg":"Hum… Não consigo chegar a esta página"},"hideDetails":"Ocultar detalhes","iconClass":"icon-elixir-thinking","isOfflineError":false,"is_windows_xbox_sku":"false","language":"pt","reloadButton":{"msg":"Atualizar","reloadUrl":"https://jsdelivr.net/"},"suggestionsDetails":[{"body":"Verifique os cabos de rede, o modem e os roteadores.","header":"Verifique sua conexão com a Internet"},{"body":"Se já estiver listado como um programa com permissão para acessar a rede, tente\n      removê-lo da lista e adicioná-lo novamente.","header":"Permita que o Microsoft Edge acesse a rede nas configurações do antivírus\n          ou do firewall."},{"body":"Ir para\n          o menu Microsoft Edge configurações >\n          \u003Cspan jscontent=\"settingsTitle\">Configurações\u003C/span>\n          >\n          \u003Cspan jscontent=\"advancedTitle\">Sistema\u003C/span>\n          >\n          \u003Cspan jscontent=\"proxyTitle\">Abrir as configurações de proxy do computador\u003C/span>\n          >\n          LAN\n          e desmarque a caixa de seleção \"Usar um servidor proxy para sua LAN\".","header":"Se você usar um servidor proxy:"}],"suggestionsSummaryList":[{"summary":"Verificando a conexão"},{"summary":"\u003Ca href=\"#buttons\" onclick=\"toggleHelpBox()\">Verificação de proxy e firewall\u003C/a>"}],"suggestionsSummaryListHeader":"Tente:","summary":{"msg":"\u003Cstrong jscontent=\"hostName\">jsdelivr.net\u003C/strong> demorou muito tempo para responder"},"textdirection":"ltr","title":"jsdelivr.net"};</script></body></html>